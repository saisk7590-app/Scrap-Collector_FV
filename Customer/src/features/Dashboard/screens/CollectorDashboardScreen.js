      ...
      <FlatList
              ...
              <View style={styles.headerStats}>
                <View style={styles.statCard}>
                  ...
                  <View style={styles.statusRow}>
                    <Text style={styles.completedText}>{stats.completed}</Text>
                    <Text style={styles.separator}> / </Text>
                    <Text style={styles.pendingText}>{stats.pending}</Text>
                  </View>
                </View>
        ...
        renderItem={({ item: pickup }) => (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("PickupDetails", { pickup })}
          >
            <View
              style={[
                styles.scheduleCard,
                {
                  borderLeftColor:
                    pickup.status === "scheduled" ? "#F97316" : "#22C55E",
                },
              ]}
            >
