          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryRow}>
              <View>
                ...
                <Text style={styles.summaryValue}>{completedPickups.length}</Text>
              </View>
              <View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.rowItem}>
                ...
                <Text style={styles.rowText}>{pickup.total_weight || 0} kg</Text>
              </View>
            </View>
            ...
            <View style={styles.footer}>
              ...
              <Text style={[styles.payment, styles.cash]}>Cash</Text>
            </View>
          </View>
        )}
      />
